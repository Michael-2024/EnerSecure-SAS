...
const DashboardSidebar = ({ onNavigate = () => {}, currentPage = 'overview' }) => {
  ...
  return (
    <div className="w-64 bg-gray-900 border-r border-gray-700 shadow-xl p-4 sm:p-6 flex flex-col min-h-screen" style={{ minHeight: '100vh', height: '100vh' }}>
      {/* Logo y Título */}
      ...
      {/* Contenedor inferior con scroll independiente */}
      <div className="flex-shrink-0 mt-auto">
        ...
        <div className="mb-4 p-4 bg-gradient-to-r from-gray-800 to-gray-900 border border-gray-700 rounded-lg">
          <div className="flex items-center">
            <div className="w-10 h-10 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center text-black font-bold shadow-lg flex-shrink-0">
              U
            </div>
            <div className="ml-3 min-w-0">
              <p className="text-white font-medium text-sm truncate">Usuario Demo</p>
              <p className="text-gray-400 text-xs truncate">demo@enersecure.com</p>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full text-left px-4 py-3 rounded-lg font-medium text-red-400 hover:text-red-300 hover:bg-red-900/20 hover:border hover:border-red-700/50 transition-all duration-200 flex items-center space-x-3 group mb-4"
        >
